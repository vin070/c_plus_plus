...
//Recursive approach
// linked_list* merge_two_sorted_linked_lists(linked_list* head1, linked_list* head2) {
//     if(!head1) return head2;
//     else if(!head2) return head1;
    
//     if(head1->get_data() <= head2->get_data()) {
//         linked_list* ans = merge_two_sorted_linked_lists(head1->get_next(), head2);
//         head1->set_next(ans);
//         return head1;
//     }
//     else {
//         linked_list* ans = merge_two_sorted_linked_lists(head1, head2->get_next());
//         head2->set_next(ans);
//         return head2;
//     }
// }
...
int main() {
  ...
  std::cin>>test_cases;
  while(test_cases--) {
    linked_list* head1 = linked_list::take_input();
    linked_list* head2 = linked_list::take_input();
    linked_list* sorted_head = merge_two_sorted_linked_lists(head1,head2);
    linked_list::print(sorted_head);
    linked_list::delete_all(sorted_head);
  }
  return 0;
}